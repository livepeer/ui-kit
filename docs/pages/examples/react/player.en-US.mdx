...
as well as a theme to use for the livepeer.js React components across the app (we use `next-themes` for theming across the docs,
but this is not a necessary dependency).
...
// We use next-themes in our documentation for light/dark theming!
