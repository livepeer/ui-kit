...
<SyncedTabs group="chain" items={['wagmi', 'aptos']}>
  <SyncedTab>
    ...
    [`connectkit`](https://docs.family.co/connectkit) for the
    wallet connection flow. It integrates easily with `wagmi` hooks, as well as WalletConnect and Metamask
...
to IPFS, then generate [ERC-1155 compatible metadata](https://eips.ethereum.org/EIPS/eip-1155#metadata) in
...
Here is an [example](https://ipfs.livepeer.studio/ipfs/bafkreieahfmjcey7gdy22xitre2ijskg7zkg5cm732c354sduwlz7tfg7q) of
the ERC-1155 compatible metadata which will be created in IPFS. 
The metadata can also be customized to override any of these default fields!


```json
{
  "animation_url": "ipfs://bafybeiar26nqkdtiyrzbaxwcdm7zkr2o36xljqskdvg6z6ugwlmpkdhamy/?loop=1&v=c6aahonu1mkijh8u",
  "description": "Livepeer video from asset \"earth.mp4\"",
  "external_url": "https://lvpr.tv/?muted=0&v=c6aahonu1mkijh8u",
  "image": "ipfs://bafkreidmlgpjoxgvefhid2xjyqjnpmjjmq47yyrcm6ifvoovclty7sm4wm",
  "name": "earth.mp4",
  "properties": {
    "com.livepeer.playbackId": "c6aahonu1mkijh8u",
