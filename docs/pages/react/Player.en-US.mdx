...
<Callout>
  ...
  the Player will upload the content from IPFS/Arweave, and then play the transcoded content back. This may take a few minutes. If `fallback` is specified,
  it will attempt playback instantly from the provided gateway or default gateway.
</Callout>
