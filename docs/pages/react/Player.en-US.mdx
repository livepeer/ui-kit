...
<Callout>
  An IPFS [v0 or v1 CID](https://docs.ipfs.tech/concepts/content-addressing/) or IPFS/Arweave URL (such as `ipfs://<CID>`, `ipfs://<CID>/asset.mp4`, `https://<CID>.ipfs.dweb.link/` or
  `https://cloudflare-ipfs.com/ipfs/<CID>`, `ar://<HASH>`, `https://<SUBDOMAIN>.arweave.dev/<HASH>` or `https://arweave.net/<HASH>`, _including directories_)
