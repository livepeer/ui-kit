...
|                      | [wagmi](https://github.com/livepeer/livepeer.js)                                                | [web3-react](https://github.com/NoahZinsmeister/web3-react)                                             | [useDApp](https://github.com/EthWorks/useDApp)                                                     | [web3modal](https://github.com/Web3Modal/web3modal)                                                     |
| -------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
...
## [wagmi](https://github.com/livepeer/livepeer.js)
...
- Used by [ENS](https://ens.domains), [Foundation](https://foundation.app), [SushiSwap](https://sushi.com), and [more](https://github.com/livepeer/livepeer.js/discussions/201)
- MIT License
