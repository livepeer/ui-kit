...
description: "The configureChains function allows you to configure your chains with providers such as: Alchemy, Infura, or something else. This means you don't need to worry about defining RPC URLs and chain configuration in your connector or provider. This is managed internally by livepeer."
---
...
```ts
import { configureChains, createClient, defaultChains } from 'livepeer';
import { alchemyProvider } from 'livepeer/providers/alchemy';
...
```ts
import { Chain, configureChains } from 'livepeer';
import { alchemyProvider } from 'livepeer/providers/alchemy';
import { infuraProvider } from 'livepeer/providers/infura';
import { jsonRpcProvider } from 'livepeer/providers/jsonRpc';
