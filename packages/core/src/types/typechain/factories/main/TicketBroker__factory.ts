...
import type {
  TicketBroker,
  TicketBrokerInterface,
} from "../../main/TicketBroker";
...
export class TicketBroker__factory {
  static readonly abi = _abi;
  static createInterface(): TicketBrokerInterface {
    return new utils.Interface(_abi) as TicketBrokerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TicketBroker {
    return new Contract(address, _abi, signerOrProvider) as TicketBroker;
  }
}
