...
import type {
  L1BondingManager,
  L1BondingManagerInterface,
} from "../../bridge/L1BondingManager";
...
export class L1BondingManager__factory {
  static readonly abi = _abi;
  static createInterface(): L1BondingManagerInterface {
    return new utils.Interface(_abi) as L1BondingManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): L1BondingManager {
    return new Contract(address, _abi, signerOrProvider) as L1BondingManager;
  }
}
